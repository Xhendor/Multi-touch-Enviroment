...
public class CriteriaUtil<T> extends BaseDAO<T> {
    ...
    private int rowsCount(Criteria criteria) {
        try {
            ...
            int rows = ((Integer) criteria.list().get(0)).intValue();
            return rows;
        } catch (Exception e) {
    ...
    /**
     * MÈtodo auxiliar para llenar la lista de criterios cuando el tipo de
    ...
    private void getCriteriaForOrBetweenType(Criteria c, CriterioBusqueda criterio, List<String> listaAlias)
        ...
        //List<Object> values=(ArrayList<Object>)criterio.getValor();
    ...
    private ArrayList<String> getSingleProperties(Criteria c, CriterioBusqueda criterio, List<String> listaAlias) {
        ...
        ArrayList<String> singleProperties = new ArrayList<String>();
