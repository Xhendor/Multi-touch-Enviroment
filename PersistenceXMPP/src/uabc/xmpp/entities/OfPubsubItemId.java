...
/**
 * OfPubsubItemId generated by hbm2java
 */
public class OfPubsubItemId  implements java.io.Serializable {
    ...
    public OfPubsubItemId() {
    }

    public OfPubsubItemId(String serviceId, String nodeId, String id) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof OfPubsubItemId) ) return false;
		 OfPubsubItemId castOther = ( OfPubsubItemId ) other; 
