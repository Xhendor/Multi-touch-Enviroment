...
/**
 * OfPubsubNodeJidsId generated by hbm2java
 */
public class OfPubsubNodeJidsId  implements java.io.Serializable {
    ...
    public OfPubsubNodeJidsId() {
    }

    public OfPubsubNodeJidsId(String serviceId, String nodeId, String jid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof OfPubsubNodeJidsId) ) return false;
		 OfPubsubNodeJidsId castOther = ( OfPubsubNodeJidsId ) other; 
